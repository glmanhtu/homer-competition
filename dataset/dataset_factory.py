...
def get_dataset(dataset_path: str, mode, is_training, image_size_p1, image_size_p2, ref_box_size,
                transforms=None, fold=1, k_fold=5, all_data=False):
    if mode == 'first_twin':
        return PapyrusDataset(dataset_path, is_training=is_training, image_size=image_size_p1,
                              transforms=transforms, fold=fold, k_fold=k_fold, all_data=all_data)
        ...
        return PapyrusValDataset(dataset_path, is_training, fold=fold, k_fold=k_fold, all_data=all_data)
